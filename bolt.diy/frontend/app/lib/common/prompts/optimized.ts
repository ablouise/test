...
<system_constraints>
  - Operating in dockerClient, an in-browser Node.js runtime
  ...
  - dockerClient CANNOT execute diff or patch editing so always write your code in full no partial/diff update
...
27. dockerClient CANNOT execute diff or patch editing so always write your code in full no partial/diff update
